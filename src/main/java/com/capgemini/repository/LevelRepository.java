...
public enum LevelRepository {
	...
	CHUCK_NORRIS_OF_BOARD_GAMES(10, 76801, 405, 0.72);
	...
	LevelRepository(int value, int pointsRequired, int gamesRequired, double winsRequired) {
		this.value = value;
	...
	public static LevelRepository getLevelByValue(int value) {
		for (LevelRepository level : LevelRepository.values()) {
